!function(e) {
    ...
    if (e(window).on("load", (function() {
        e(".preloader").fadeOut(),
        e(".hero-overlay-ani").addClass("ani-start")
    }
    )),
        ...
        return this.each((function() {
            ...
            e(n).each((function() {
                e(this).on("click", (function(t) {
                    ...
                    o.find("ul").slideUp(a.toggleSpeed).removeClass(a.subMenuToggleClass),
                    n.toggleClass(a.subMenuParentToggle),
                    e(s).next("ul").slideToggle(a.toggleSpeed).toggleClass(a.subMenuToggleClass)
                }
                ))
            }
            )),
    ...
    var o, i, r, c = ".ajax-contact", l = '[name="email"]', d = e(".form-messages");
    function p() {
        var t = e(c).serialize();
        (function() {
            var t, a = !0;
            ...
            e(l).val() && e(l).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (e(l).removeClass("is-invalid"),
            a = !0) : (e(l).addClass("is-invalid"),
            a = !1);
            return a
        }
        )() && jQuery.ajax({
    ...
    e.fn.sectionPosition = function(t, a) {
        e(this).each((function() {
            ...
            "top-half" === n ? (e(o).css("padding-bottom", r + s + "px"),
            c.css("margin-top", "-" + s + "px")) : "bottom-half" === n && (e(o).css("padding-top", i + s + "px"),
