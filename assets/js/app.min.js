...
!function(e, t) {
    ...
    var s, r, a = function(e) {
        ...
        Object.keys(i).forEach((function(n) {
            var s, r = i[n], a = t[n], o = a && p(a) ? "element" : null == (s = a) ? "" + s : {}.toString.call(s).match(/\s([a-z]+)/i)[1].toLowerCase();
            if (!new RegExp(r).test(o))
                throw new Error(e.toUpperCase() + ': Option "' + n + '" provided type "' + o + '" but expected type "' + r + '".')
        }
        ))
    }, m = function(e) {
        if (!e)
    ...
    function P(e, t, i) {
        ...
        for (var n = Object.keys(e), s = 0, r = n.length; s < r; s++) {
            var a = e[n[s]];
            if (a.originalHandler === t && a.delegationSelector === i)
                return a
        }
        return null
    }
    ...
    function z(e, t, i, n, s) {
        if ("string" == typeof t && e) {
            ...
            if (u)
                ...
                var p = I(o, t.replace(E, ""))
                  , h = a ? function(e, t, i) {
                    return function n(s) {
                        for (var r = e.querySelectorAll(t), a = s.target; a && a !== this; a = a.parentNode)
    ...
    var j = {
            ...
            if ("string" == typeof t && e) {
                ...
                if (void 0 === a) {
                    c && Object.keys(d).forEach((function(i) {
                        !function(e, t, i, n) {
                            ...
                            Object.keys(s).forEach((function(r) {
                                if (r.includes(n)) {
                                    var a = s[r];
                                    W(e, t, i, a.originalHandler, a.delegationSelector)
                                }
                            }
                            ))
                        }(e, d, i, t.slice(1))
                    ...
                    Object.keys(u).forEach((function(i) {
                        ...
                        if (!l || t.includes(n)) {
                            var s = u[i];
                            W(e, d, o, s.originalHandler, s.delegationSelector)
                        }
                    }
                    ))
                } else {
        ...
        trigger: function(e, t, i) {
            if ("string" != typeof t || !e)
                return null;
            var n, s = y(), r = t.replace(T, ""), a = t !== r, o = O.has(r), l = !0, d = !0, c = !1, u = null;
            return a && s && (n = s.Event(t, i),
            s(e).trigger(n),
            l = !n.isPropagationStopped(),
            d = !n.isImmediatePropagationStopped(),
            c = n.isDefaultPrevented()),
            o ? (u = document.createEvent("HTMLEvents")).initEvent(r, l, !0) : u = new CustomEvent(t,{
                bubbles: l,
                cancelable: !0
            }),
    ...
    var q = {
      ...
      , J = function(e) {
        ...
        r.pause = function(e) {
            e || (this._isPaused = !0),
            V.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (u(this._element),
            this.cycle(!0)),
        ...
        r._setActiveIndicatorElement = function(e) {
            if (this._indicatorsElement) {
                for (var t = V.find(".active", this._indicatorsElement), i = 0; i < t.length; i++)
        ...
        r._slide = function(e, t) {
            var i, n, s, r = this, a = V.findOne(".active.carousel-item", this._element), o = this._getItemIndex(a), l = t || a && this._getItemByDirection(e, a), d = this._getItemIndex(l), u = Boolean(this._interval);
            ...
            l && l.classList.contains("active"))
                ...
                this._element.classList.contains("slide")) {
                    ...
                    l.classList.add(i);
                    var p = c(a);
                    j.one(a, "transitionend", (function() {
    ...
    j.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", J.dataApiClickHandler),
    j.on(window, "load.bs.carousel.data-api", (function() {
        for (var e = V.find('[data-bs-ride="carousel"]'), t = 0, i = e.length; t < i; t++)
    ...
    var Q = "collapse"
      ...
      , ee = function(e) {
        function s(t, i) {
            ...
            for (var s = V.find('[data-bs-toggle="collapse"]'), r = 0, a = s.length; r < a; r++) {
                var o = s[r]
                  , d = l(o)
                  , c = V.find(d).filter((function(e) {
                    return e === t
                }
                ));
                null !== d && c.length && (n._selector = d,
                n._triggerArray.push(o))
            }
        ...
        r.show = function() {
            ...
            if (!this._isTransitioning && !this._element.classList.contains("show")) {
                var t, i;
                this._parent && 0 === (t = V.find(".show, .collapsing", this._parent).filter((function(t) {
        ...
        r._getParent = function() {
            ...
            return V.find(i, t).forEach((function(t) {
                var i = d(t);
        ...
        s.collapseInterface = function(e, t) {
            var n = S(e, "bs.collapse")
              , r = i({}, K, q.getDataAttributes(e), "object" == typeof t && t ? t : {});
    ...
    var Ce = {
        ...
        phase: "main",
        fn: function(e) {
            var t, i = e.state, n = e.name, s = i.elements.arrow, r = i.modifiersData.popperOffsets, a = fe(i.placement), o = Se(a), l = [se, ne].indexOf(a) >= 0 ? "height" : "width";
            if (s && r) {
                var d = i.modifiersData[n + "#persistent"].padding
                  , c = me(s)
                  , u = "y" === o ? te : se
                  , p = "y" === o ? ie : ne
                  , h = i.rects.reference[l] + i.rects.reference[o] - r[o] - i.rects.popper[l]
        ...
        effect: function(e) {
            ...
            t.modifiersData[n + "#persistent"] = {
                padding: Te("number" != typeof o ? o : Me(o, re))
            })
        },
    ...
    function De(e) {
        var t, i = e.popper, n = e.popperRect, s = e.placement, r = e.offsets, a = e.position, o = e.gpuAcceleration, l = e.adaptive, d = function(e) {
            var t = e.x
              , i = e.y
        ...
        return o ? Object.assign(Object.assign({}, b), {}, ((y = {})[m] = h ? "0" : "",
        y[f] = p ? "0" : "",
    ...
    var Oe = {
        ...
        fn: function(e) {
            ...
            null != t.modifiersData.popperOffsets && (t.styles.popper = Object.assign(Object.assign({}, t.styles.popper), De(Object.assign(Object.assign({}, o), {}, {
                offsets: t.modifiersData.popperOffsets,
                position: t.options.strategy,
                adaptive: a
            })))),
            null != t.modifiersData.arrow && (t.styles.arrow = Object.assign(Object.assign({}, t.styles.arrow), De(Object.assign(Object.assign({}, o), {}, {
    ...
    function Re(e, t) {
        return "viewport" === t ? Ye(function(e) {
            ...
            var t = be(e)
              ...
              , a = -i.scrollLeft + He(e)
              , o = -i.scrollTop;
            return "rtl" === ve(n || t).direction && (a += Math.max(t.clientWidth, n ? n.clientWidth : 0) - s),
            {
                width: s,
                height: r,
                x: a,
    ...
    function Ve(e) {
        var t, i = e.reference, n = e.element, s = e.placement, r = s ? fe(s) : null, a = s ? qe(s) : null, o = i.x + i.width / 2 - n.width / 2, l = i.y + i.height / 2 - n.height / 2;
        switch (r) {
        case te:
            t = {
                x: o,
    ...
    var $e = {
        ...
        fn: function(e) {
            ...
            if (!t.modifiersData[n]._skip) {
                for (var s = i.mainAxis, r = void 0 === s || s, a = i.altAxis, o = void 0 === a || a, l = i.fallbackPlacements, d = i.padding, c = i.boundary, u = i.rootBoundary, p = i.altBoundary, h = i.flipVariations, f = void 0 === h || h, m = i.allowedAutoPlacements, g = t.options.placement, v = fe(g), y = l || (v !== g && f ? function(e) {
                    if ("auto" === fe(e))
                        return [];
                    var t = Le(e);
                    return [We(e), t, We(t)]
                ...
                if (S)
                    for (var z = function(e) {
                        ...
                        ;
                t.placement !== E && (t.modifiersData[n]._skip = !0,
                t.placement = E,
                t.reset = !0)
            }
        },
            ...
            if (x) {
                if (r) {
                    var C = "y" === w ? te : se
                      ...
                      , F = N[k]
                      , B = Ee(0, S[D], j[D])
                      , Y = b ? S[D] / 2 - P - B - H - T : L - B - H - T
                      , R = b ? -S[D] / 2 + P + B + F + T : z + B + F + T
                      ...
                      , $ = x[w] + Y - G - V
                      , X = x[w] + R - G
                      , U = Ee(h ? Math.min(I, $) : I, O, h ? Math.max(A, X) : A);
                    x[w] = U,
                    M[w] = U - O
                }
                if (o) {
    ...
    function et(e, t, i) {
        void 0 === i && (i = !1);
        var n, s, r = be(t), a = je(e), o = pe(t), l = {
            scrollLeft: 0,
            scrollTop: 0
        }, d = {
            x: 0,
        ...
        return (o || !o && !i) && (("body" !== de(t) || Fe(r)) && (l = (n = t) !== ce(n) && pe(n) ? {
            scrollLeft: (s = n).scrollLeft,
            scrollTop: s.scrollTop
        } : Ne(n)),
        pe(t) ? ((d = je(t)).x += t.clientLeft,
        d.y += t.clientTop) : r && (d.x = He(r))),
        {
        ...
        return function(e, t, i) {
            ...
            var s, a, o = {
                ...
                setOptions: function(i) {
                    u(),
                    o.options = Object.assign(Object.assign(Object.assign({}, r), o.options), i),
                    o.scrollParents = {
                        reference: ue(e) ? Be(e) : e.contextElement ? Be(e.contextElement) : [],
                        popper: Be(t)
                    };
                    var s, a, d = function(e) {
                        var t = function(e) {
                            var t = new Map
                              , i = new Set
                              , n = [];
    ...
    var st = nt()
      ...
      , at = nt({
        defaultModifiers: [Ae, Ke, Oe, he, Qe, $e, Ze, Ce, Je]
    })
      , ot = Object.freeze({
        __proto__: null,
        popperGenerator: nt,
      ...
      , yt = function(e) {
        ...
        r.hide = function() {
            if (!this._element.disabled && !this._element.classList.contains("disabled") && this._menu.classList.contains("show")) {
                ...
                j.trigger(e, "hide.bs.dropdown", t).defaultPrevented || (this._popper && this._popper.destroy(),
                this._menu.classList.toggle("show"),
                this._element.classList.toggle("show"),
        ...
        s.clearMenus = function(e) {
            if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                for (var t = V.find('[data-bs-toggle="dropdown"]'), i = 0, n = t.length; i < n; i++) {
                    ...
                    a) {
                        var l, d = a._menu;
                        if (t[i].classList.contains("show") && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && d.contains(e.target) || j.trigger(r, "hide.bs.dropdown", o).defaultPrevented))
                            ...
                            j.trigger(r, "hidden.bs.dropdown", o)
                    }
                }
        }
        ,
      ...
      , _t = function(e) {
        ...
        r._showBackdrop = function(e) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                j.one(this._backdrop, "transitionend", e),
                h(this._backdrop, n)
        ...
        r._triggerBackdropTransition = function() {
            ...
            if (!j.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented) {
                ...
                j.one(this._element, "transitionend", (function() {
                    ...
                    t || (j.one(e._element, "transitionend", (function() {
    ...
    function Tt(e, t, i) {
        ...
        if (i && "function" == typeof i)
            return i(e);
        for (var s = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(t), a = (n = []).concat.apply(n, s.body.querySelectorAll("*")), o = function(e, i) {
            var n, s = a[e], o = s.nodeName.toLowerCase();
            if (!r.includes(o))
            ...
            l.forEach((function(e) {
                (function(e, t) {
                    ...
                    if (t.includes(i))
                        return !xt.has(i) || Boolean(e.nodeValue.match(St) || e.nodeValue.match(Et));
    ...
    var Mt = "tooltip"
      ...
      , Pt = function(e) {
        ...
        r.setContent = function() {
            ...
            this.setElementContent(V.findOne(".tooltip-inner", e), this.getTitle()),
        ...
        r._enter = function(e, t) {
            ...
            (t = t || S(e.delegateTarget, i)) || (t = new this.constructor(e.delegateTarget,this._getDelegateConfig()),
    ...
    b((function() {
        ...
        if (e) {
            var t = e.fn[Mt];
            e.fn[Mt] = Pt.jQueryInterface,
            e.fn[Mt].Constructor = Pt,
    ...
    b((function() {
        ...
        if (e) {
            var t = e.fn[Lt];
            e.fn[Lt] = Ht.jQueryInterface,
            e.fn[Lt].Constructor = Ht,
            e.fn[Lt].noConflict = function() {
                return e.fn[Lt] = t,
                Ht.jQueryInterface
            }
    ...
    var Ft = "scrollspy"
      ...
      , Rt = function(e) {
        ...
        return r.refresh = function() {
            ...
            V.find(this._selector).map((function(e) {
                var t = l(e)
                  , s = t ? V.findOne(t) : null;
                if (s) {
        ...
        r._activate = function(e) {
            ...
            var t = this._selector.split(",").map((function(t) {
              ...
              , i = V.findOne(t.join(","));
            i.classList.contains("dropdown-item") ? (V.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add("active"),
        ...
        ,
        r._clear = function() {
            V.find(this._selector).filter((function(e) {
    ...
    var qt = function(e) {
        ...
        s._activate = function(e, t, i) {
            var n = this
              , s = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? V.children(t, ".active") : V.find(":scope > li > .active", t))[0]
        ...
        s._transitionComplete = function(e, t, i) {
            ...
            e.parentNode && e.parentNode.classList.contains("dropdown-menu") && (e.closest(".dropdown") && V.find(".dropdown-toggle").forEach((function(e) {
                return e.classList.add("active")
            }
            )),
            e.setAttribute("aria-expanded", !0)),
    ...
    j.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', (function(e) {
        e.preventDefault(),
        (S(this, "bs.tab") || new qt(this)).show()
    }
    )),
    b((function() {
        var e = y();
    ...
    var Vt = {
      ...
      , $t = function(e) {
        ...
        return r.show = function() {
            ...
            if (!j.trigger(this._element, "show.bs.toast").defaultPrevented) {
                ...
                this._config.animation) {
                    ...
                    j.one(this._element, "transitionend", t),
                    h(this._element, i)
                } else
                    t()
            }
        ...
        ,
        r._getConfig = function(e) {
            return e = i({}, Gt, q.getDataAttributes(this._element), "object" == typeof e && e ? e : {}),
        ...
        initFill: function() {
            ...
            n.gradient) {
                ...
                if (1 == a.length)
                    ...
                    for (var o = n.gradientAngle || 0, l = n.gradientDirection || [r / 2 * (1 - Math.cos(o)), r / 2 * (1 + Math.sin(o)), r / 2 * (1 + Math.cos(o)), r / 2 * (1 - Math.sin(o))], d = s.createLinearGradient.apply(s, l), c = 0; c < a.length; c++) {
                        var u = a[c]
                          , p = c / (a.length - 1);
                        e.isArray(u) && (p = u[1],
                        u = u[0]),
    ...
    e.fn.circleProgress = function(i, n) {
        ...
        return this.each((function() {
            ...
            if (r)
                ...
                "string" == typeof o.animation && (o.animation = JSON.parse(o.animation)),
                (a = e.extend(o, a)).el = n,
                r = new t(a),
                n.data(s, r)
            }
...
function(e, t) {
    ...
    function n(e, t, s) {
        ...
        void setTimeout(this.check.bind(this))) : void o.error("Bad element for imagesLoaded " + (d || e))
    }
    function s(e) {
        this.img = e
    }
            ...
            (t = this).each((function(e, t) {
                ...
                if (s) {
                    ...
                    if (r && "_" != n.charAt(0)) {
                        ...
                        a(c + " is not a valid method")
                } else
                    a(i + " not initialized. Cannot call methods, i.e. " + c)
            }
            )),
            void 0 !== d ? d : t
        }
...
function(e, t) {
    ...
    , s = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], r = s.length, a = !1;
    return function n(o) {
        if (function() {
            if (!a) {
                a = !0;
        ...
        i.docReady((function() {
            ...
            d.forEach((function(e) {
                ...
                try {
                    ...
                    return void (s && s.error("Error parsing " + a + " on " + e.className + ": " + i))
                }
                var o = new t(e,i);
                u && u.data(e, n, o)
            }
...
function(e, t) {
    ...
    function r(e, t) {
        ...
        if (i) {
            ...
            o && o.error("Bad element for " + this.constructor.namespace + ": " + (i || e))
    }
    function a(e) {
        function t() {
...
function(e, t) {
    ...
    n._getItemLayoutPosition = function(e) {
        ...
        for (var n = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, e), s = {
            ...
            y: n.y
        }, r = n.y + e.size.outerHeight, a = i + n.col, o = n.col; o < a; o++)
            this.colYs[o] = r;
        return s
    }
    ,
    ...
    n._manageStamp = function(e) {
        ...
        for (var l = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, d = a; d <= o; d++)
...
function(e, t) {
    ...
    var u = function(e) {
        if ("string" != typeof e)
            return e;
        var t, i, n = l(e).split(" "), s = n[0], r = s.match(/^\[(.+)\]$/), a = r && r[1], o = (i = s,
        (t = a) ? function(e) {
            ...
            function(e, t) {
                for (var s = 0; s < i.length; s++) {
                    var r = i[s]
                      ...
                      , o = t.sortData[r];
                    if (o < a || a < o)
                        return (o < a ? 1 : -1) * ((void 0 !== n[r] ? n[r] : n) ? 1 : -1)
                }
                return 0
            }
            );
...
function(e) {
    ...
    e.widget = function(t, i, n) {
        var s, r, a, o = {}, l = t.split(".")[0], d = l + "-" + (t = t.split(".")[1]);
        return n || (n = i,
        i = e.Widget),
    ...
    e.widget.extend = function(t) {
        for (var i, s, r = n.call(arguments, 1), a = 0, o = r.length; a < o; a++)
            for (i in r[a])
                s = r[a][i],
                r[a].hasOwnProperty(i) && void 0 !== s && (e.isPlainObject(s) ? t[i] = e.isPlainObject(t[i]) ? e.widget.extend({}, t[i], s) : e.widget.extend({}, s) : t[i] = s);
        return t
    }
    ,
    e.widget.bridge = function(t, i) {
        ...
        e.fn[t] = function(r) {
            ...
            return a ? this.length || "instance" !== r ? this.each((function() {
                ...
                !1) : n ? e.isFunction(n[r]) && "_" !== r.charAt(0) ? (i = n[r].apply(n, o)) !== n && void 0 !== i ? (l = i && i.jquery ? l.pushStack(i.get()) : i,
    ...
    e.each({
        ...
        e.Widget.prototype["_" + t] = function(n, s, r) {
            ...
            a && e.effects && e.effects.effect[o] ? n[t](s) : o !== t && n[o] ? n[o](s.duration, s.easing, r) : n.queue((function(i) {
                e(this)[t](),
                r && r.call(n[0]),
                i()
            }
    ...
    e.widget("ui.slider", e.ui.mouse, {
        ...
        _mouseCapture: function(t) {
            var i, n, s, r, a, o, l = this, d = this.options;
            ...
            this.handles.each((function(t) {
                ...
                (a < n || n === a && (t === l._lastChangedValue || l.values(t) === d.min)) && (n = a,
                s = e(this),
                r = t)
            }
            )),
        ...
        _refreshValue: function() {
            var t, i, n, s, r, a = this.options.range, o = this.options, l = this, d = !this._animateOff && o.animate, c = {};
            ...
            "min" === a && "horizontal" === this.orientation && this.range.stop(1, 1)[d ? "animate" : "css"]({
                width: i + "%"
            }, o.animate),
            "max" === a && "horizontal" === this.orientation && this.range.stop(1, 1)[d ? "animate" : "css"]({
                width: 100 - i + "%"
            }, o.animate),
            "min" === a && "vertical" === this.orientation && this.range.stop(1, 1)[d ? "animate" : "css"]({
                height: i + "%"
            }, o.animate),
            "max" === a && "vertical" === this.orientation && this.range.stop(1, 1)[d ? "animate" : "css"]({
                height: 100 - i + "%"
            }, o.animate))
        },
        _handleEvents: {
    ...
    t.prototype.refresh = function() {
        ...
        e = {
            ...
            for (var o in this.waypoints[r]) {
                var l, d, c, u, p = this.waypoints[r][o], h = p.options.offset, f = p.triggerPoint, m = 0, g = null == f;
                ...
                u = !d && !c,
                !g && (d && c) ? (p.queueTrigger(a.backward),
                n[p.group.id] = p.group) : (!g && u || g && a.oldScroll >= p.triggerPoint) && (p.queueTrigger(a.forward),
            ...
            t.waypoint((function(r) {
                !function() {
                    var r = []
                      ...
                      , l = /[0-9]+,[0-9]+/.test(o)
                      , d = ((o = o.replace(/,/g, "")).split(".")[1] || []).length;
                    ...
                    for (var h = a; h >= s.beginAt / o * a; h--) {
                        var f = parseFloat(o / a * h).toFixed(d);
                        if (c) {
                            f = parseInt(i / a * h);
...
function() {
    ...
    i = function(e) {
        ...
        t = 1; t < arguments.length; t++)
            if (n = arguments[t])
                for (var s in n)
                    n.hasOwnProperty(s) && ("object" == typeof n[s] ? i(e[s], n[s]) : e[s] = n[s]);
        return e
    }
    ,
    n = function(e, t) {
    ...
    (DateFormatter = function(e) {
        ...
        parseDate: function(t, i) {
            var n, s, r, a, o, l, d, c, u, p, h = this, f = !1, m = !1, g = h.dateSettings, v = {
                date: null,
                year: null,
                month: null,
                day: null,
            ...
            if (t instanceof Date)
                return t;
            if ("U" === i)
                return (r = parseInt(t)) ? new Date(1e3 * r) : t;
            switch (typeof t) {
            case "number":
                return new Date(t);
            case "string":
            ...
            for (s = t.replace(h.separators, "\0").split("\0"),
            r = 0; r < s.length; r++)
                switch (a = s[r],
                o = parseInt(a),
                n[r]) {
                ...
                case "Y":
                    if (!o)
                        return null;
                    u = a.length,
                    v.year = 2 === u ? parseInt((o < 70 ? "20" : "19") + a) : o,
                    f = !0;
                    break;
                case "m":
                case "n":
                ...
                case "g":
                case "h":
                    if (p = s[d = -1 < n.indexOf("a") ? n.indexOf("a") : -1 < n.indexOf("A") ? n.indexOf("A") : -1],
                    -1 < d)
                        c = e(p, g.meridiem[0]) ? 0 : e(p, g.meridiem[1]) ? 12 : -1,
                        1 <= o && o <= 12 && -1 < c ? v.hour = o + c - 1 : 0 <= o && o <= 23 && (v.hour = o);
                    else {
                        if (!(0 <= o && o <= 23))
                            return null;
                        v.hour = o
        ...
        guessDate: function(e, t) {
            if ("string" != typeof e)
                return e;
            var i, n, s, r, a, o, l = e.replace(this.separators, "\0").split("\0"), d = t.match(this.validParts), c = new Date, u = 0;
            if (!/^[djmn]/g.test(d[0]))
                return e;
            for (s = 0; s < l.length; s++) {
                if (u = 2,
                a = l[s],
                o = parseInt(a.substr(0, 2)),
                isNaN(o))
                    return null;
                switch (s) {
                case 0:
                    "m" === d[0] || "n" === d[0] ? c.setMonth(o - 1) : c.setDate(o);
                    break;
                case 1:
                    "m" === d[0] || "n" === d[0] ? c.setDate(o) : c.setMonth(o - 1);
                    break;
                case 2:
                    if (n = c.getFullYear(),
                    u = (i = a.length) < 4 ? i : 4,
                    !(n = parseInt(i < 4 ? n.toString().substr(0, 4 - i) + a : a.substr(0, 4))))
                        return null;
                    c.setFullYear(n);
                    break;
                case 3:
                ...
                0 < (r = a.substr(u)).length && l.splice(s + 1, 0, r)
            }
            return c
        },
        parseFormat: function(e, i) {
            var n, s = this, r = s.dateSettings, a = /\\?(.?)/gi, o = function(e, t) {
                return n[e] ? n[e]() : t
            };
            return n = {
                d: function() {
        ...
        formatDate: function(e, t) {
            ...
            if (e instanceof Date) {
                for (s = t.length,
                i = 0; i < s; i++)
                    "S" !== (a = t.charAt(i)) && "\\" !== a && (0 < i && "\\" === t.charAt(i - 1) ? o += a : (r = this.parseFormat(a, e),
                    i !== s - 1 && this.intParts.test(a) && "S" === t.charAt(i + 1) && (n = parseInt(r) || 0,
...
var datetimepickerFactory = function(e) {
    ...
    e.datetimepicker = {
        ...
        setDateFormatter: function(n) {
            if ("string" == typeof n && o.hasOwnProperty(n)) {
                var s = o[n];
                e.extend(t, s.default_options),
                i = s.formatter
            } else
                i = n
        }
    ...
    e.fn.xdsoftScroller = function(t, i) {
        return this.each((function() {
            var n, s, r, a, o, l = e(this), d = function(e) {
                var t, i = {
                    x: 0,
                    y: 0
                };
                ...
                i.y = e.clientY),
                i
            }, c = 100, u = !1, p = 0, h = 0, f = 0, m = !1, g = 0, v = function() {};
            "hide" !== i ? (e(this).hasClass("xdsoft_scroller_box") || (n = l.children().eq(0),
            s = l[0].clientHeight,
            r = n[0].offsetHeight,
            a = e('<div class="xdsoft_scrollbar"></div>'),
            o = e('<div class="xdsoft_scroller"></div>'),
            a.append(o),
            l.addClass("xdsoft_scroller_box").append(a),
            v = function(e) {
                var t = d(e).y - p + g;
                t < 0 && (t = 0),
                t + o[0].offsetHeight > f && (t = f - o[0].offsetHeight),
            ...
            o.on("touchstart.xdsoft_scroller mousedown.xdsoft_scroller", (function(n) {
                ...
                p = d(n).y,
                g = parseInt(o.css("margin-top"), 10),
                f = a[0].offsetHeight,
            ...
            l.on("scroll_element.xdsoft_scroller", (function(e, t) {
                ...
                1 < d ? o.hide() : (o.show(),
                o.css("height", parseInt(10 < u ? u : 10, 10)),
                c = a[0].offsetHeight - o[0].offsetHeight,
                !0 !== i && l.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(n.css("marginTop"), 10)) / (r - s)]))
            }
            )),
    ...
    e.fn.datetimepicker = function(n, r) {
        ...
        return a = function(t) {
            ...
            I.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", (function(t) {
                var i, n, s = e(this).find(".xdsoft_select").eq(0), r = 0, a = 0, o = s.is(":visible");
                for (I.find(".xdsoft_select").hide(),
                M.currentTime && (r = M.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()),
                s[o ? "hide" : "show"](),
                i = s.find("div.xdsoft_option"),
                n = 0; n < i.length && i.eq(n).data("value") !== r; n += 1)
                    a += i[0].offsetHeight;
                return s.xdsoftScroller(T, a / (s.children()[0].offsetHeight - s[0].clientHeight)),
                t.stopPropagation(),
                !1
            }
            ));
            ...
            function Y() {
                var e, i = !1;
                return T.startDate ? i = M.strToDate(T.startDate) : (i = T.value || (t && t.val && t.val() ? t.val() : "")) ? (i = M.strToDateTime(i),
                T.yearOffset && (i = new Date(i.getFullYear() - T.yearOffset,i.getMonth(),i.getDate(),i.getHours(),i.getMinutes(),i.getSeconds(),i.getMilliseconds()))) : T.defaultDate && (i = M.strToDateTime(T.defaultDate),
                T.defaultTime && (e = M.strtotime(T.defaultTime),
            ...
            function R(n) {
                ...
                "string" === e.type(n.mask) && (s(n.mask, t.val()) || (t.val(n.mask.replace(/[0-9]/g, "_")),
                r(t[0], 0)),
                t.on("paste.xdsoft", (function(i) {
                    var a = (i.clipboardData || i.originalEvent.clipboardData || window.clipboardData).getData("text")
                      , o = this.value
                      , l = this.selectionStart;
                    return o = o.substr(0, l) + a + o.substr(l + a.length),
                    l += a.length,
                    s(n.mask, o) ? (this.value = o,
                    r(this, l)) : "" === e.trim(o) ? this.value = n.mask.replace(/[0-9]/g, "_") : t.trigger("error_input.xdsoft"),
                    i.preventDefault(),
                    !1
                }
                )),
                t.on("keydown.xdsoft", (function(i) {
                    var a, o = this.value, l = i.which, c = this.selectionStart, T = this.selectionEnd, M = c !== T;
                    if (48 <= l && l <= 57 || 96 <= l && l <= 105 || 8 === l || 46 === l) {
                        for (a = 8 === l || 46 === l ? "_" : String.fromCharCode(96 <= l && l <= 105 ? l - 48 : l),
                        8 === l && c && !M && (c -= 1); ; ) {
                        ...
                        M) {
                            var O = T - c
                              ...
                              , A = I.substr(c, O).substr(1);
                            o = o.substr(0, c) + (a + A) + o.substr(c + O)
                        } else
                            o = o.substr(0, c) + a + o.substr(c + 1);
                        if ("" === e.trim(o))
                            o = I;
                        ...
                        for (c += 8 === l ? 0 : 1; /[^0-9_]/.test(n.mask.substr(c, 1)) && c < n.mask.length && 0 < c; )
                            c += 8 === l ? 0 : 1;
                        s(n.mask, o) ? (this.value = o,
                        r(this, c)) : "" === e.trim(o) ? this.value = n.mask.replace(/[0-9]/g, "_") : t.trigger("error_input.xdsoft")
                    } else if (-1 !== [b, w, _, x, S].indexOf(l) && E || -1 !== [p, f, g, h, m, y, d, v, u].indexOf(l))
                        return !0;
                    return i.preventDefault(),
                    !1
                }
            ...
            I.find(".xdsoft_select").xdsoftScroller(T).on("touchstart mousedown.xdsoft", (function(e) {
                var t = e.originalEvent;
                this.touchMoved = !1,
                ...
                if (!this.touchMoved) {
                    ...
                    T.onChangeMonth && e.isFunction(T.onChangeMonth) && T.onChangeMonth.call(k, M.currentTime, k.data("input")),
                    t !== M.currentTime.getFullYear() && e.isFunction(T.onChangeYear) && T.onChangeYear.call(k, M.currentTime, k.data("input"))
                }
            }
            )),
            k.getValue = function() {
            ...
            k.setOptions = function(n) {
                var s = {};
                T = e.extend(!0, {}, T, n),
                n.allowTimes && e.isArray(n.allowTimes) && n.allowTimes.length && (T.allowTimes = e.extend(!0, [], n.allowTimes)),
                n.weekends && e.isArray(n.weekends) && n.weekends.length && (T.weekends = e.extend(!0, [], n.weekends)),
                n.allowDates && e.isArray(n.allowDates) && n.allowDates.length && (T.allowDates = e.extend(!0, [], n.allowDates)),
                n.allowDateRe && "[object String]" === Object.prototype.toString.call(n.allowDateRe) && (T.allowDateRe = new RegExp(n.allowDateRe)),
                n.highlightedDates && e.isArray(n.highlightedDates) && n.highlightedDates.length && (e.each(n.highlightedDates, (function(t, n) {
                    var r, a = e.map(n.split(","), e.trim), o = new c(i.parseDate(a[0], T.formatDate),a[1],a[2]), l = i.formatDate(o.date, T.formatDate);
                    void 0 !== s[l] ? (r = s[l].desc) && r.length && o.desc && o.desc.length && (s[l].desc = r + "\n" + o.desc) : s[l] = o
                }
                )),
                T.highlightedDates = e.extend(!0, [], s)),
                n.highlightedPeriods && e.isArray(n.highlightedPeriods) && n.highlightedPeriods.length && (s = e.extend(!0, [], T.highlightedDates),
                e.each(n.highlightedPeriods, (function(t, n) {
                    ...
                    if (e.isArray(n))
                        ...
                        a = i.parseDate(h[1], T.formatDate),
                        o = h[2],
                        p = h[3]
                    }
                    for (; r <= a; )
                        ...
                        void 0 !== s[d] ? (u = s[d].desc) && u.length && l.desc && l.desc.length && (s[d].desc = u + "\n" + l.desc) : s[d] = l
                }
                )),
                T.highlightedDates = e.extend(!0, [], s)),
                n.disabledDates && e.isArray(n.disabledDates) && n.disabledDates.length && (T.disabledDates = e.extend(!0, [], n.disabledDates)),
                n.disabledWeekDays && e.isArray(n.disabledWeekDays) && n.disabledWeekDays.length && (T.disabledWeekDays = e.extend(!0, [], n.disabledWeekDays)),
                !T.open && !T.opened || T.inline || t.trigger("open.xdsoft"),
                T.inline && (H = !0,
                k.addClass("xdsoft_inline"),
                t.after(k).hide()),
                T.inverseButton && (T.next = "xdsoft_prev",
                T.prev = "xdsoft_next"),
                T.datepicker ? O.addClass("active") : O.removeClass("active"),
                T.timepicker ? P.addClass("active") : P.removeClass("active"),
                T.value && (M.setCurrentTime(T.value),
                t && t.val && t.val(M.str)),
                isNaN(T.dayOfWeekStart) ? T.dayOfWeekStart = 0 : T.dayOfWeekStart = parseInt(T.dayOfWeekStart, 10) % 7,
                T.timepickerScrollbar || L.xdsoftScroller(T, "hide"),
                T.minDate && /^[\+\-](.*)$/.test(T.minDate) && (T.minDate = i.formatDate(M.strToDateTime(T.minDate), T.formatDate)),
                T.maxDate && /^[\+\-](.*)$/.test(T.maxDate) && (T.maxDate = i.formatDate(M.strToDateTime(T.maxDate), T.formatDate)),
                T.minDateTime && /^\+(.*)$/.test(T.minDateTime) && (T.minDateTime = M.strToDateTime(T.minDateTime).dateFormat(T.formatDate)),
                T.maxDateTime && /^\+(.*)$/.test(T.maxDateTime) && (T.maxDateTime = M.strToDateTime(T.maxDateTime).dateFormat(T.formatDate)),
                W.toggle(T.showApplyButton),
                I.find(".xdsoft_today_button").css("visibility", T.todayButton ? "visible" : "hidden"),
                I.find("." + T.prev).css("visibility", T.prevButton ? "visible" : "hidden"),
                I.find("." + T.next).css("visibility", T.nextButton ? "visible" : "hidden"),
                R(T),
                T.validateOnBlur && t.off("blur.xdsoft").on("blur.xdsoft", (function() {
                    if (T.allowBlank && (!e.trim(e(this).val()).length || "string" == typeof T.mask && e.trim(e(this).val()) === T.mask.replace(/[0-9]/g, "_")))
                        e(this).val(null),
                        k.data("xdsoft_datetime").empty();
                    else {
                        var t = i.parseDate(e(this).val(), T.format);
                        if (t)
                            e(this).val(i.formatDate(t, T.format));
                        else {
                ...
                T.dayOfWeekStartPrev = 0 === T.dayOfWeekStart ? 6 : T.dayOfWeekStart - 1,
            ...
            M = new function() {
                ...
                t.setCurrentTime = function(e, i) {
                    "string" == typeof e ? t.currentTime = t.strToDateTime(e) : t.isValidDate(e) ? t.currentTime = e : e || i || !T.allowBlank || T.inline ? t.currentTime = t.now() : t.currentTime = null,
                    k.trigger("xchange.xdsoft")
                }
                ,
                t.empty = function() {
                ...
                t.nextMonth = function() {
                    ...
                    T.onChangeMonth && e.isFunction(T.onChangeMonth) && T.onChangeMonth.call(k, M.currentTime, k.data("input")),
                    i !== t.currentTime.getFullYear() && e.isFunction(T.onChangeYear) && T.onChangeYear.call(k, M.currentTime, k.data("input")),
                    k.trigger("xchange.xdsoft"),
                    n
                }
                ,
                ...
                t.strToDateTime = function(e) {
                    var n, s, r = [];
                    return e && e instanceof Date && t.isValidDate(e) ? e : ((r = /^([+-]{1})(.*)$/.exec(e)) && (r[2] = i.parseDate(r[2], T.formatDate)),
                    s = r && r[2] ? (n = r[2].getTime() - 6e4 * r[2].getTimezoneOffset(),
                    new Date(t.now(!0).getTime() + parseInt(r[1] + "1", 10) * n)) : e ? i.parseDate(e, T.format) : t.now(),
                ...
                t.str = function() {
                    var e = T.format;
                    return T.yearOffset && (e = (e = e.replace("Y", t.currentTime.getFullYear() + T.yearOffset)).replace("y", String(t.currentTime.getFullYear() + T.yearOffset).substring(2, 4))),
            ...
            I.find(".xdsoft_today_button").on("touchend mousedown.xdsoft", (function() {
                ...
                n < (e = new Date(e.getFullYear(),e.getMonth(),e.getDate())) || (i = M.strToDate(T.maxDate),
                (i = new Date(i.getFullYear(),i.getMonth(),i.getDate())) < n || (t.val(M.str()),
                t.trigger("change"),
                k.trigger("close.xdsoft")))
            }
            )),
            I.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", (function() {
                var t = e(this)
                  ...
                  , n = !1;
                !function e(s) {
                    t.hasClass(T.next) ? M.nextMonth() : t.hasClass(T.prev) && M.prevMonth(),
                    T.monthChangeSpinner && (n || (i = setTimeout(e, s || 100)))
                }(500),
                e([T.ownerDocument.body, T.contentWindow]).on("touchend mouseup.xdsoft", (function t() {
                    clearTimeout(i),
                    n = !0,
                    e([T.ownerDocument.body, T.contentWindow]).off("touchend mouseup.xdsoft", t)
                }
                ))
            }
            )),
            P.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", (function() {
                var t = e(this)
                  ...
                  , s = 110;
                !function e(r) {
                    var a = L[0].clientHeight
                      , o = z[0].offsetHeight
                      , l = Math.abs(parseInt(z.css("marginTop"), 10));
                    t.hasClass(T.next) && o - a - T.timeHeightInTimePicker >= l ? z.css("marginTop", "-" + (l + T.timeHeightInTimePicker) + "px") : t.hasClass(T.prev) && 0 <= l - T.timeHeightInTimePicker && z.css("marginTop", "-" + (l - T.timeHeightInTimePicker) + "px"),
                    L.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(z[0].style.marginTop, 10) / (o - a))]),
                    s = 10 < s ? 10 : s - 10,
            ...
            r = 0,
            k.on("xchange.xdsoft", (function(a) {
                clearTimeout(r),
                r = setTimeout((function() {
                    void 0 !== M.currentTime && null !== M.currentTime || (M.currentTime = M.now());
                    for (var r, a, o, l, d, c, u, p, h, f, m = "", g = new Date(M.currentTime.getFullYear(),M.currentTime.getMonth(),1,12,0,0), v = 0, y = M.now(), b = !1, w = !1, _ = !1, x = !1, S = [], E = !0, C = ""; g.getDay() !== T.dayOfWeekStart; )
                        g.setDate(g.getDate() - 1);
                    for (m += "<table><thead><tr>",
                    T.weeks && (m += "<th></th>"),
                    r = 0; r < 7; r += 1)
                        m += "<th>" + T.i18n[s].dayOfWeekShort[(r + T.dayOfWeekStart) % 7] + "</th>";
                    for (m += "</tr></thead>",
                    m += "<tbody>",
                    !1 !== T.maxDate && (b = M.strToDate(T.maxDate),
                    b = new Date(b.getFullYear(),b.getMonth(),b.getDate(),23,59,59,999)),
                    !1 !== T.minDate && (w = M.strToDate(T.minDate),
                    w = new Date(w.getFullYear(),w.getMonth(),w.getDate())),
                    !1 !== T.minDateTime && (_ = M.strToDate(T.minDateTime),
                    _ = new Date(_.getFullYear(),_.getMonth(),_.getDate(),_.getHours(),_.getMinutes(),_.getSeconds())),
                    !1 !== T.maxDateTime && (x = M.strToDate(T.maxDateTime),
                    x = new Date(x.getFullYear(),x.getMonth(),x.getDate(),x.getHours(),x.getMinutes(),x.getSeconds())),
                    !1 !== x && (f = 31 * (12 * x.getFullYear() + x.getMonth()) + x.getDate()); v < M.currentTime.countDaysInMonth() || g.getDay() !== T.dayOfWeekStart || M.currentTime.getMonth() === g.getMonth(); ) {
                        S = [],
                        v += 1,
                        o = g.getDay(),
                        l = g.getDate(),
                        ...
                        h = "",
                        S.push("xdsoft_date"),
                        u = T.beforeShowDay && e.isFunction(T.beforeShowDay.call) ? T.beforeShowDay.call(k, g) : null,
                        T.allowDateRe && "[object RegExp]" === Object.prototype.toString.call(T.allowDateRe) && (T.allowDateRe.test(i.formatDate(g, T.formatDate)) || S.push("xdsoft_disabled")),
                        T.allowDates && 0 < T.allowDates.length && -1 === T.allowDates.indexOf(i.formatDate(g, T.formatDate)) && S.push("xdsoft_disabled");
                        var D = 31 * (12 * g.getFullYear() + g.getMonth()) + g.getDate();
                        (!1 !== b && b < g || !1 !== _ && g < _ || !1 !== w && g < w || !1 !== x && f < D || u && !1 === u[0]) && S.push("xdsoft_disabled"),
                        -1 !== T.disabledDates.indexOf(i.formatDate(g, T.formatDate)) && S.push("xdsoft_disabled"),
                        -1 !== T.disabledWeekDays.indexOf(o) && S.push("xdsoft_disabled"),
                        t.is("[disabled]") && S.push("xdsoft_disabled"),
                        u && "" !== u[1] && S.push(u[1]),
                        M.currentTime.getMonth() !== W && S.push("xdsoft_other_month"),
                        (T.defaultSelect || k.data("changed")) && i.formatDate(M.currentTime, T.formatDate) === i.formatDate(g, T.formatDate) && S.push("xdsoft_current"),
                        i.formatDate(y, T.formatDate) === i.formatDate(g, T.formatDate) && S.push("xdsoft_today"),
                        0 !== g.getDay() && 6 !== g.getDay() && -1 === T.weekends.indexOf(i.formatDate(g, T.formatDate)) || S.push("xdsoft_weekend"),
                        void 0 !== T.highlightedDates[i.formatDate(g, T.formatDate)] && (a = T.highlightedDates[i.formatDate(g, T.formatDate)],
                        S.push(void 0 === a.style ? "xdsoft_highlighted_default" : a.style),
                        h = void 0 === a.desc ? "" : a.desc),
                        T.beforeShowDay && e.isFunction(T.beforeShowDay) && S.push(T.beforeShowDay(g)),
                        E && (m += "<tr>",
                        E = !1,
                        T.weeks && (m += "<th>" + c + "</th>")),
                        m += '<td data-date="' + l + '" data-month="' + W + '" data-year="' + d + '" class="xdsoft_date xdsoft_day_of_week' + g.getDay() + " " + S.join(" ") + '" title="' + h + '"><div>' + l + "</div></td>",
                        g.getDay() === T.dayOfWeekStartPrev && (m += "</tr>",
                        E = !0),
                        g.setDate(l + 1)
                    }
                    m += "</tbody></table>",
                    A.html(m),
                    I.find(".xdsoft_label span").eq(0).text(T.i18n[s].months[M.currentTime.getMonth()]),
                    I.find(".xdsoft_label span").eq(1).text(M.currentTime.getFullYear() + T.yearOffset),
                    W = C = "";
                    var O = 0;
                    if (!1 !== T.minTime) {
                        var P = M.strtotime(T.minTime);
                        O = 60 * P.getHours() + P.getMinutes()
                    }
                    var L = 1440;
                    if (!1 !== T.maxTime && (P = M.strtotime(T.maxTime),
                    L = 60 * P.getHours() + P.getMinutes()),
                    !1 !== T.minDateTime && (P = M.strToDateTime(T.minDateTime),
                    i.formatDate(M.currentTime, T.formatDate) === i.formatDate(P, T.formatDate))) {
                        var W = 60 * P.getHours() + P.getMinutes();
                        O < W && (O = W)
                    }
                    if (!1 !== T.maxDateTime && (P = M.strToDateTime(T.maxDateTime),
                    i.formatDate(M.currentTime, T.formatDate) === i.formatDate(P, T.formatDate) && (W = 60 * P.getHours() + P.getMinutes()) < L && (L = W)),
                    p = function(n, s) {
                        var r, a = M.now(), o = T.allowTimes && e.isArray(T.allowTimes) && T.allowTimes.length;
                        a.setHours(n),
                        n = parseInt(a.getHours(), 10),
                        a.setMinutes(s),
                        s = parseInt(a.getMinutes(), 10),
                        S = [];
                        var l = 60 * n + s;
                        (t.is("[disabled]") || L <= l || l < O) && S.push("xdsoft_disabled"),
                        (r = new Date(M.currentTime)).setHours(parseInt(M.currentTime.getHours(), 10)),
                        o || r.setMinutes(Math[T.roundTime](M.currentTime.getMinutes() / T.step) * T.step),
                        (T.initTime || T.defaultSelect || k.data("changed")) && r.getHours() === parseInt(n, 10) && (!o && 59 < T.step || r.getMinutes() === parseInt(s, 10)) && (T.defaultSelect || k.data("changed") ? S.push("xdsoft_current") : T.initTime && S.push("xdsoft_init_time")),
                        parseInt(y.getHours(), 10) === parseInt(n, 10) && parseInt(y.getMinutes(), 10) === parseInt(s, 10) && S.push("xdsoft_today"),
                        C += '<div class="xdsoft_time ' + S.join(" ") + '" data-hour="' + n + '" data-minute="' + s + '">' + i.formatDate(a, T.formatTime) + "</div>"
                    }
                    ,
                    T.allowTimes && e.isArray(T.allowTimes) && T.allowTimes.length)
                        for (v = 0; v < T.allowTimes.length; v += 1)
                            p(M.strtotime(T.allowTimes[v]).getHours(), W = M.strtotime(T.allowTimes[v]).getMinutes());
                    else
                        for (r = v = 0; v < (T.hours12 ? 12 : 24); v += 1)
                            for (r = 0; r < 60; r += T.step) {
                                var H = 60 * v + r;
                                H < O || L <= H || p((v < 10 ? "0" : "") + v, W = (r < 10 ? "0" : "") + r)
                            }
                    for (z.html(C),
                    n = "",
                    v = parseInt(T.yearStart, 10); v <= parseInt(T.yearEnd, 10); v += 1)
                        n += '<div class="xdsoft_option ' + (M.currentTime.getFullYear() === v ? "xdsoft_current" : "") + '" data-value="' + v + '">' + (v + T.yearOffset) + "</div>";
                    for (N.children().eq(0).html(n),
                    v = parseInt(T.monthStart, 10),
                    n = ""; v <= parseInt(T.monthEnd, 10); v += 1)
                        n += '<div class="xdsoft_option ' + (M.currentTime.getMonth() === v ? "xdsoft_current" : "") + '" data-value="' + v + '">' + T.i18n[s].months[v] + "</div>";
                ...
                var e, t, i, n;
                T.timepicker && (z.find(".xdsoft_current").length ? e = ".xdsoft_current" : z.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"),
                e ? (t = L[0].clientHeight,
                (i = z[0].offsetHeight) - t < (n = z.find(e).index() * T.timeHeightInTimePicker + 1) && (n = i - t),
                L.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (i - t)])) : L.trigger("scroll_element.xdsoft_scroller", [0]))
            }
            )),
            a = 0,
            A.on("touchend click.xdsoft", "td", (function(i) {
                ...
                t.val(M.str()),
                T.onSelectDate && e.isFunction(T.onSelectDate) && T.onSelectDate.call(k, M.currentTime, k.data("input"), i),
                k.data("changed", !0),
                k.trigger("xchange.xdsoft"),
                k.trigger("changedatetime.xdsoft"),
                (1 < a || !0 === T.closeOnDateSelect || !1 === T.closeOnDateSelect && !T.timepicker) && !T.inline && k.trigger("close.xdsoft"),
                setTimeout((function() {
                    a = 0
                }
                ), 200)
            ...
            z.on("touchstart", "div", (function(e) {
                ...
                if (!this.touchMoved) {
                    ...
                    T.onSelectTime && e.isFunction(T.onSelectTime) && T.onSelectTime.call(k, M.currentTime, k.data("input"), t),
                    k.data("changed", !0),
                    k.trigger("xchange.xdsoft"),
                    k.trigger("changedatetime.xdsoft"),
                    !0 !== T.inline && !0 === T.closeOnTimeSelect && k.trigger("close.xdsoft")
                }
            }
            )),
            O.on("mousewheel.xdsoft", (function(e) {
                return !T.scrollMonth || (e.deltaY < 0 ? M.nextMonth() : M.prevMonth(),
                !1)
            }
            )),
            t.on("mousewheel.xdsoft", (function(e) {
                return !T.scrollInput || (!T.datepicker && T.timepicker ? (0 <= (o = z.find(".xdsoft_current").length ? z.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY && o + e.deltaY < z.children().length && (o += e.deltaY),
                z.children().eq(o).length && z.children().eq(o).trigger("mousedown"),
                !1) : T.datepicker && !T.timepicker ? (O.trigger(e, [e.deltaY, e.deltaX, e.deltaY]),
                t.val && t.val(M.str()),
                k.trigger("changedatetime.xdsoft"),
                !1) : void 0)
            }
            ...
            k.on("changedatetime.xdsoft", (function(t) {
                ...
                T.onGenerate && e.isFunction(T.onGenerate) && T.onGenerate.call(k, M.currentTime, k.data("input")),
                H && (k.trigger("afterOpen.xdsoft"),
                H = !1)
            }
            ...
            ,
            l = function() {
                var t, i, n, s, r, a, o, l, d, c, u, p, h;
                if (t = (l = k.data("input")).offset(),
                i = l[0],
                c = "top",
                ...
                T.ownerDocument.documentElement.clientWidth - t.left < O.parent().outerWidth(!0)) {
                    var f = O.parent().outerWidth(!0) - i.offsetWidth;
                    s -= f
                }
                "rtl" === l.parent().css("direction") && (s -= k.outerWidth() - l.outerWidth()),
                T.fixed ? (n -= h,
                s -= e(T.contentWindow).scrollLeft(),
                r = "fixed") : (o = !1,
                C(i, (function(e) {
                    return null !== e && ("fixed" === T.contentWindow.getComputedStyle(e).getPropertyValue("position") ? !(o = !0) : void 0)
                }
                )),
                o && !T.insideParent ? (r = "fixed",
                n + k.outerHeight() > p + h ? (c = "bottom",
                n = p + h - t.top) : n -= h) : n + k[0].offsetHeight > p + h && (n = t.top - k[0].offsetHeight + 1),
                n < 0 && (n = 0),
                s + i.offsetWidth > d && (s = d - i.offsetWidth)),
                a = k[0],
                C(a, (function(e) {
                    if ("relative" === T.contentWindow.getComputedStyle(e).getPropertyValue("position") && d >= e.offsetWidth)
                        return s -= (d - e.offsetWidth) / 2,
                        !1
                }
                )),
                u = {
                ...
                T.insideParent ? u[c] = i.offsetTop + i.offsetHeight : u[c] = n,
                k.css(u)
            }
            ,
            k.on("open.xdsoft", (function(t) {
                var i = !0;
                T.onShow && e.isFunction(T.onShow) && (i = T.onShow.call(k, M.currentTime, k.data("input"), t)),
                !1 !== i && (k.show(),
                l(),
                e(T.contentWindow).off("resize.xdsoft", l).on("resize.xdsoft", l),
                T.closeOnWithoutClick && e([T.ownerDocument.body, T.contentWindow]).on("touchstart mousedown.xdsoft", (function t() {
                    k.trigger("close.xdsoft"),
                    e([T.ownerDocument.body, T.contentWindow]).off("touchstart mousedown.xdsoft", t)
                }
                )))
            }
                ...
                T.onClose && e.isFunction(T.onClose) && (i = T.onClose.call(k, M.currentTime, k.data("input"), t)),
            ...
            k.setOptions(T),
            M.setCurrentTime(Y()),
            t.data("xdsoft_datetimepicker", k).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", (function() {
                t.is(":disabled") || t.data("xdsoft_datetimepicker").is(":visible") && T.closeOnInputClick || T.openOnFocus && (clearTimeout(F),
                ...
                var i, n = t.which;
                return -1 !== [u].indexOf(n) && T.enterLikeTab ? (i = e("input:visible,textarea:visible,button:visible,a:visible"),
                k.trigger("close.xdsoft"),
                i.eq(i.index(this) + 1).focus(),
                !1) : -1 !== [v].indexOf(n) ? (k.trigger("close.xdsoft"),
                !0) : void 0
            }
        ...
        o = function(t) {
            ...
            e([T.contentWindow, T.ownerDocument.body]).off("mousedown.xdsoft touchstart"),
        ...
        this.each((function() {
            ...
            if (s) {
                if ("string" === e.type(n))
                    ...
                    case "reset":
                        ...
                        this.value && s.data("xdsoft_datetime").isValidDate(i.parseDate(this.value, T.format)) || s.data("changed", !1),
            ...
            "string" !== e.type(n) && (!T.lazyInit || T.open || T.inline ? a(e(this)) : (t = e(this)).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", (function e() {
                t.is(":disabled") || t.data("xdsoft_datetimepicker") || (clearTimeout(M),
                M = setTimeout((function() {
                    t.data("xdsoft_datetimepicker") || a(t),
...
function(e) {
    ...
    var t, i, n = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], s = "onwheel"in document || 9 <= document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], r = Array.prototype.slice;
    if (e.event.fixHooks)
    ...
    function l(n) {
        var s, a = n || window.event, l = r.call(arguments, 1), u = 0, p = 0, h = 0, f = 0, m = 0;
        if ((n = e.event.fix(a)).type = "mousewheel",
...
function(e) {
    ...
    var t, i, n, s, r, a, o = "Close", l = "BeforeClose", d = "MarkupParse", c = "Open", u = "Change", p = "mfp", h = ".mfp", f = "mfp-ready", m = "mfp-removing", g = "mfp-prevent-close", v = function() {}, y = !!window.jQuery, b = e(window), w = function(e, i) {
        t.ev.on(p + e + h, i)
    }, _ = function(t, i, n, s) {
    ...
    ;
    var T, M, C, k = "inline", D = function() {
        C && (M.after(C.addClass(T)).detach(),
        C = null)
    };
            ...
            getImage: function(i, n) {
                var s = 0
                  , r = function() {
                    ...
                    i.hasSize = !0,
                    i.loaded = !0,
                    x("ImageLoadComplete")) : 200 > ++s ? setTimeout(r, 100) : a())
                }
                  , a = function() {
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(i) {
                ...
                W ? o["-moz-transform"] = o.transform = "translate(" + s.left + "px," + s.top + "px)" : (o.left = s.left,
                o.top = s.top),
                o
            }
        }
        ...
        proto: {
            initGallery: function() {
                ...
                w(d + s, (function(e, n, s, r) {
                    ...
                    s.counter = a > 1 ? F(i.tCounter, r.index, a) : ""
                }
                )),
...
var Swiper = function() {
    ...
    function M(e) {
        ...
        S || (S = function(e) {
            ...
            const p = a.match(/(iPod)(.*OS\s([\d_]+))?/)
              ...
              , f = "Win32" === s;
            let m = "MacIntel" === s;
            return !u && m && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${d}`) >= 0 && (u = a.match(/(Version)\/([\d.]+)/),
            u || (u = [0, 1, "13_0_0"]),
            m = !1),
            c && !f && (o.os = "android",
            o.android = !0),
    ...
    function A(e) {
        ...
        let _ = !0;
        p.matches(a.focusableElements) && (_ = !1,
        "SELECT" === p.nodeName && (a.isTouched = !1)),
        i.activeElement && i.activeElement.matches(a.focusableElements) && i.activeElement !== p && i.activeElement.blur();
        const x = _ && t.allowTouchMove && l.touchStartPreventDefault;
        !l.touchStartForcePreventDefault && !x || p.isContentEditable || u.preventDefault(),
    ...
    function P(e) {
        const t = n()
          , i = this
          , s = i.touchEventsData
          , {params: r, touches: a, rtlTranslate: l, enabled: d} = i;
        if (!d)
            return;
        ...
        v > 0 ? (w && _ && !x && s.currentTranslate > (r.centeredSlides ? i.minTranslate() - i.size / 2 : i.minTranslate()) && i.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
        }),
        s.currentTranslate > i.minTranslate() && (S = !1,
        r.resistance && (s.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + s.startTranslate + v) ** E))) : v < 0 && (w && _ && !x && s.currentTranslate < (r.centeredSlides ? i.maxTranslate() + i.size / 2 : i.maxTranslate()) && i.loopFix({
            direction: "next",
            setTranslate: !0,
            activeSlideIndex: i.slides.length - ("auto" === r.slidesPerView ? i.slidesPerViewDynamic() : Math.ceil(parseFloat(r.slidesPerView, 10)))
        }),
        s.currentTranslate < i.maxTranslate() && (S = !1,
        r.resistance && (s.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - s.startTranslate - v) ** E))),
    ...
    const V = {
        ...
        update: {
            ...
            updateSlides: function() {
                ...
                const n = e.params
                  , {wrapperEl: s, slidesEl: r, size: a, rtlTranslate: o, wrongRTL: l} = e
                ...
                for (let s = 0; s < h; s += 1) {
                    ...
                    !p[s] || "none" !== v(r, "display")) {
                        if ("auto" === n.slidesPerView) {
                            ...
                            D = (a - (n.slidesPerView - 1) * E) / n.slidesPerView,
                            n.roundLengths && (D = Math.floor(D)),
                            p[s] && (p[s].style[t("width")] = D + "px");
                        p[s] && (p[s].swiperSlideSize = D),
                        y.push(D),
                        n.centeredSlides ? (T = T + D / 2 + M / 2 + E,
                        0 === M && 0 !== s && (T = T - a / 2 - E),
                        0 === s && (T = T - a / 2 - E),
                        Math.abs(T) < .001 && (T = 0),
                ...
                if (e.virtualSize = Math.max(e.virtualSize, a) + w,
                o && l && ("slide" === n.effect || "coverflow" === n.effect) && (s.style.width = e.virtualSize + E + "px"),
                ...
                m.length !== x && (e.params.watchOverflow && e.checkOverflow(),
            ...
            updateSlidesProgress: function(e) {
                ...
                for (let e = 0; e < n.length; e += 1) {
                    ...
                    const c = (a + (i.centeredSlides ? t.minTranslate() : 0) - d) / (l.swiperSlideSize + o)
                      , u = (a - r[0] + (i.centeredSlides ? t.minTranslate() : 0) - d) / (l.swiperSlideSize + o)
                      , p = -(a - d)
            ...
            updateActiveIndex: function(e) {
                const t = this
                  ...
                  , {snapGrid: n, params: s, activeIndex: r, realIndex: a, snapIndex: o} = t;
                let l, d = e;
                const c = e => {
        ...
        slide: {
            slideTo: function(e, t, i, n, s) {
                ...
                let a = e;
                a < 0 && (a = 0);
                const {params: o, snapGrid: l, slidesGrid: d, previousIndex: c, activeIndex: u, rtlTranslate: h, wrapperEl: f, enabled: m} = r;
                if (r.animating && o.preventInteractionOnTransition || !m && !n && !s)
                    return !1;
                ...
                if (r.initialized && a !== u) {
                    if (!r.allowSlideNext && (h ? y > r.translate && y > r.minTranslate() : y < r.translate && y < r.minTranslate()))
                        return !1;
                    if (!r.allowSlidePrev && y > r.translate && y > r.maxTranslate() && (u || 0) !== a)
                        return !1
                }
                let b;
                if (a !== (c || 0) && i && r.emit("beforeSlideChangeStart"),
                r.updateProgress(y),
            ...
            slidePrev: function(e, t, i) {
                ...
                void 0 === t && (t = !0);
                const n = this
                  , {params: s, snapGrid: r, slidesGrid: a, rtlTranslate: o, enabled: l, animating: d} = n;
                if (!l)
                    return n;
            ...
            slideToClickedSlide: function() {
                ...
                if (t.loop) {
                    ...
                    r = e.getSlideIndex(f(i, `${o}[data-swiper-slide-index="${s}"]`)[0]),
                    a( () => {
                        e.slideTo(r)
                    }
        ...
        events: {
            attachEvents: function() {
                ...
                e.onClick = W.bind(e),
                e.onLoad = N.bind(e),
                H || (t.addEventListener("touchstart", F),
                H = !0),
                B(e, "on")
            },
    ...
    class $ {
        ...
        static use(e) {
            return Array.isArray(e) ? (e.forEach(e => $.installModule(e)),
            $) : ($.installModule(e),
            $)
        }
    }
    ...
    function te(e) {
        const {effect: t, swiper: i, on: n, setTranslate: s, setTransition: r, overwriteParams: a, perspective: o, recreateShadows: l, getEffectParams: d} = e;
        let c;
        n("beforeInit", () => {
    ...
    $.use([function(e) {
        ...
        i("init", () => {
            t.params.resizeObserver && void 0 !== s.ResizeObserver ? t && !t.destroyed && t.initialized && (a = new ResizeObserver(e => {
                o = s.requestAnimationFrame( () => {
                    ...
                    e.forEach(e => {
                        ...
                        a && a !== t.el || (s = n ? n.width : (i[0] || i).inlineSize,
            ...
            a.observe(t.el)) : (s.addEventListener("resize", l),
    ...
    const re = [function(e) {
        ...
        function c(e) {
            ...
            b = Math.floor(t / 2) + n + o) : (y = t + (n - 1) + l,
            b = (r ? t : n) + o);
            let w = g - b
              , _ = g + y;
            r || (w = Math.max(w, 0),
            ...
            c === w && u === _ && !e)
                return i.slidesGrid !== h && x !== m && i.slides.forEach(e => {
    ...
    , function(e) {
        ...
        function p() {
            ...
            "bullets" === i.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                i.dynamicMainBullets > 1 && void 0 !== r && (o += n - (r || 0),
    ...
    , function(e) {
        ...
        function _(e) {
            const i = t.params.scrollbar
              ...
              , {el: a, dragEl: o} = n;
            p = !0,
            l = e.target === o ? b(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null,
            e.preventDefault(),
            e.stopPropagation(),
        ...
        function T() {
            ...
            s || "string" != typeof n.el ? s || (s = n.el) : s = o.querySelectorAll(n.el),
    ...
    , function(e) {
        ...
        const s = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]"
          ...
          , a = () => {
            const {el: e, slides: i, progress: n, snapGrid: a, isElement: o} = t
              , l = f(e, s);
    ...
    , function(e) {
        ...
        function T(e) {
            ...
            m.currentX = m.touchesCurrent.x - m.touchesStart.x + m.startX + r * (m.width - 2 * a),
            m.currentY = m.touchesCurrent.y - m.touchesStart.y + m.startY + r * (m.height - 2 * o),
        ...
        function C(e) {
            ...
            if (!h.imageEl || !h.imageWrapEl)
                return;
            let s, r, o, l, d, u, p, v, y, w, _, x, S, E, T, M, C, k;
            ...
            1 === c && D && (s = void 0,
            r = void 0),
            i.scale = D || h.imageWrapEl.getAttribute("data-swiper-zoom") || n.maxRatio,
            c = D || h.imageWrapEl.getAttribute("data-swiper-zoom") || n.maxRatio,
            !e || 1 === c && D ? (p = 0,
            v = 0) : (C = h.slideEl.offsetWidth,
        ...
        Object.assign(t.controller, {
            setTranslate: function(e, i) {
                ...
                function l(e) {
                    ...
                    a && "container" !== t.params.controller.by || (r = (e.maxTranslate() - e.minTranslate()) / (t.maxTranslate() - t.minTranslate()),
    ...
    , function(e) {
        ...
        n("afterInit", () => {
            t.params.a11y.enabled && ( () => {
                ...
                const n = t.wrapperEl
                  , r = e.id || n.getAttribute("id") || "swiper-wrapper-" + (void 0 === (o = 16) && (o = 16),
    ...
    , function(e) {
        ...
        a("sliderFirstMove", () => {
            !s.destroyed && s.autoplay.running && (s.params.autoplay.disableOnInteraction ? S() : (u = !0,
            p = !1,
            m = !1,
            h = setTimeout( () => {
                m = !0,
        ...
        Object.assign(t, {
            freeMode: {
                ...
                onTouchEnd: function(e) {
                    ...
                    if (t.params.cssMode)
                        return;
                    const {params: r, wrapperEl: a, rtlTranslate: l, snapGrid: d, touchEventsData: c} = t
            ...
            updateSlide: (e, s, a, o) => {
                ...
                if ("row" === p && d > 1) {
                    const i = Math.floor(e / (d * u))
                      , n = e - u * d * i
                      , r = 0 === i ? d : Math.min(Math.ceil((a - i * u * d) / u), d);
                    m = Math.floor(n / r),
                    f = n - m * r + i * d,
                    h = f + m * t / u,
                    s.style.order = h
                ...
                s.row = m,
                s.column = f,
                s.style[o("margin-top")] = 0 !== m ? c && c + "px" : ""
            }
            ,
                ...
                c.shadow)
                    if (u)
                        ...
                        const e = Math.abs(f) - 90 * Math.floor(Math.abs(f) / 90)
                          ...
                          , n = c.shadowScale / t
                          , s = c.shadowOffset;
                        h.style.transform = `scale3d(${i}, 1, ${n}) translate3d(0px, ${a / 2 + s}px, ${-a / 2 / n}px) rotateX(-90deg)`
                    }
            ...
            setTranslate: () => {
                ...
                for (let l = 0; l < e.length; l += 1) {
                    ...
                    const b = t.virtual && t.params.virtual.enabled ? t.virtual.from + l : l
                      ...
                      , _ = (b === i || b === i + 1) && u < 0 && u > -1 && (a || t.params.cssMode) && o > r;
                    if (w || _) {
